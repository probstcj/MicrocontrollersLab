...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("11d6ad0a-1f02-4f6a-b329-94b95b7d95f1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3b628153-851b-4002-878b-1fa164436bec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ACCEL_INT_net;
	wire [0:0] tmpFB_0__ACCEL_INT_net;
	wire [0:0] tmpIO_0__ACCEL_INT_net;
	electrical [0:0] tmpSIOVREF__ACCEL_INT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ACCEL_INT
		 (.oe(tmpOE__ACCEL_INT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ACCEL_INT_net[0:0]}),
		  .io({tmpIO_0__ACCEL_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__ACCEL_INT_net),
		  .interrupt({Net_25}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__ACCEL_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
...
>>>>>>> 1708681267ad12d2822a02d27e7d6de5c6fc75d0
