// ======================================================================
// AutomaticPetFeeder.v generated from TopDesign.cysch
// 04/25/2023 at 15:41
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=SPEAKER_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SPEAKER_PWM, CY_INSTANCE_SHORT_NAME=SPEAKER_PWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=SPEAKER_PWM, )
...
module SCB_P4_v4_0_3 (
	...
	cy_clock_v1_0
		#(.id("a32a91a1-a5de-4d91-ad76-54644f127155/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a32a91a1-a5de-4d91-ad76-54644f127155/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a32a91a1-a5de-4d91-ad76-54644f127155/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c3e59892-9835-4564-855f-e5ba70438000"),
    ...
    begin : demux_1
        ...
        always @(Net_36 or Net_60)
        begin
            case (Net_60[1:0])
                2'b00:
                begin
                    tmp__demux_1_0_reg = Net_36;
                ...
                begin
                    ...
                    tmp__demux_1_1_reg = 1'b0;
                    tmp__demux_1_2_reg = 1'b0;
                    tmp__demux_1_3_reg = Net_36;
                end
            endcase
        end
        assign Net_55 = tmp__demux_1_0_reg;
        assign Net_56 = tmp__demux_1_1_reg;
        assign Net_57 = tmp__demux_1_2_reg;
        assign Net_58 = tmp__demux_1_3_reg;
    end
    // -- De Mux end --

    CyControlReg_v1_80 LED_SEL (
        .control_1(Net_61),
        .control_2(Net_62),
        .control_3(Net_63),
        .control_0(Net_64),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_60[1:0]));
    defparam LED_SEL.Bit0Mode = 0;
    defparam LED_SEL.Bit1Mode = 0;
    defparam LED_SEL.Bit2Mode = 0;
    defparam LED_SEL.Bit3Mode = 0;
    defparam LED_SEL.Bit4Mode = 0;
    defparam LED_SEL.Bit5Mode = 0;
    defparam LED_SEL.Bit6Mode = 0;
    defparam LED_SEL.Bit7Mode = 0;
    defparam LED_SEL.BitValue = 0;
    defparam LED_SEL.BusDisplay = 1;
    defparam LED_SEL.ExtrReset = 0;
    defparam LED_SEL.NumOutputs = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("690495ff-2fcf-4dc5-987a-833036b6d851"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Y_LED_net;
	wire [0:0] tmpFB_0__Y_LED_net;
	wire [0:0] tmpIO_0__Y_LED_net;
	wire [0:0] tmpINTERRUPT_0__Y_LED_net;
	electrical [0:0] tmpSIOVREF__Y_LED_net;
	...
	cy_psoc3_pins_v1_10
		...
		Y_LED
		 (.oe(tmpOE__Y_LED_net),
		  .y({Net_58}),
		  .fb({tmpFB_0__Y_LED_net[0:0]}),
		  .io({tmpIO_0__Y_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_LED_net),
		  .interrupt({tmpINTERRUPT_0__Y_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Motor (
        .control_1(Net_93),
        .control_2(Net_94),
        .control_3(Net_95),
        .control_0(Net_96),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Motor.Bit0Mode = 0;
    defparam Motor.Bit1Mode = 0;
    defparam Motor.Bit2Mode = 0;
    defparam Motor.Bit3Mode = 0;
    defparam Motor.Bit4Mode = 0;
    defparam Motor.Bit5Mode = 0;
    defparam Motor.Bit6Mode = 0;
    defparam Motor.Bit7Mode = 0;
    defparam Motor.BitValue = 0;
    defparam Motor.BusDisplay = 0;
    defparam Motor.ExtrReset = 0;
    defparam Motor.NumOutputs = 4;

	wire [0:0] tmpOE__PhsBNeg_net;
	wire [0:0] tmpFB_0__PhsBNeg_net;
	wire [0:0] tmpIO_0__PhsBNeg_net;
	wire [0:0] tmpINTERRUPT_0__PhsBNeg_net;
	electrical [0:0] tmpSIOVREF__PhsBNeg_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PhsBNeg
		 (.oe(tmpOE__PhsBNeg_net),
		  .y({Net_95}),
		  .fb({tmpFB_0__PhsBNeg_net[0:0]}),
		  .io({tmpIO_0__PhsBNeg_net[0:0]}),
		  .siovref(tmpSIOVREF__PhsBNeg_net),
		  .interrupt({tmpINTERRUPT_0__PhsBNeg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PhsBNeg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PhsBPos_net;
	wire [0:0] tmpFB_0__PhsBPos_net;
	wire [0:0] tmpIO_0__PhsBPos_net;
	wire [0:0] tmpINTERRUPT_0__PhsBPos_net;
	electrical [0:0] tmpSIOVREF__PhsBPos_net;

	cy_psoc3_pins_v1_10
		#(.id("5a4d8229-b3d3-41a1-9b27-f5c7e9de6ae5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PhsBPos
		 (.oe(tmpOE__PhsBPos_net),
		  .y({Net_94}),
		  .fb({tmpFB_0__PhsBPos_net[0:0]}),
		  .io({tmpIO_0__PhsBPos_net[0:0]}),
		  .siovref(tmpSIOVREF__PhsBPos_net),
		  .interrupt({tmpINTERRUPT_0__PhsBPos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PhsBPos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PhsANeg_net;
	wire [0:0] tmpFB_0__PhsANeg_net;
	wire [0:0] tmpIO_0__PhsANeg_net;
	wire [0:0] tmpINTERRUPT_0__PhsANeg_net;
	electrical [0:0] tmpSIOVREF__PhsANeg_net;

	cy_psoc3_pins_v1_10
		#(.id("ae4946d3-00f2-4a0d-aca0-88565e771e69"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PhsANeg
		 (.oe(tmpOE__PhsANeg_net),
		  .y({Net_93}),
		  .fb({tmpFB_0__PhsANeg_net[0:0]}),
		  .io({tmpIO_0__PhsANeg_net[0:0]}),
		  .siovref(tmpSIOVREF__PhsANeg_net),
		  .interrupt({tmpINTERRUPT_0__PhsANeg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PhsANeg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PhsAPos_net;
	wire [0:0] tmpFB_0__PhsAPos_net;
	wire [0:0] tmpIO_0__PhsAPos_net;
	wire [0:0] tmpINTERRUPT_0__PhsAPos_net;
	electrical [0:0] tmpSIOVREF__PhsAPos_net;

	cy_psoc3_pins_v1_10
		#(.id("40b6469d-12e6-41b0-98bc-9e99aba85236"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PhsAPos
		 (.oe(tmpOE__PhsAPos_net),
		  .y({Net_96}),
		  .fb({tmpFB_0__PhsAPos_net[0:0]}),
		  .io({tmpIO_0__PhsAPos_net[0:0]}),
		  .siovref(tmpSIOVREF__PhsAPos_net),
		  .interrupt({tmpINTERRUPT_0__PhsAPos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PhsAPos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__RTC_INT_net;
	wire [0:0] tmpFB_0__RTC_INT_net;
	wire [0:0] tmpIO_0__RTC_INT_net;
	electrical [0:0] tmpSIOVREF__RTC_INT_net;

	cy_psoc3_pins_v1_10
		#(.id("77350802-f7a1-410b-8efa-0075d69b602f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RTC_INT
		 (.oe(tmpOE__RTC_INT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTC_INT_net[0:0]}),
		  .io({tmpIO_0__RTC_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__RTC_INT_net),
		  .interrupt({Net_108}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RTC_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__RTC_COT_IN_net;
	wire [0:0] tmpFB_0__RTC_COT_IN_net;
	wire [0:0] tmpIO_0__RTC_COT_IN_net;
	wire [0:0] tmpINTERRUPT_0__RTC_COT_IN_net;
	electrical [0:0] tmpSIOVREF__RTC_COT_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("29b28d36-db99-4d73-95d4-845d6f920908"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RTC_COT_IN
		 (.oe(tmpOE__RTC_COT_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTC_COT_IN_net[0:0]}),
		  .io({tmpIO_0__RTC_COT_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__RTC_COT_IN_net),
		  .interrupt({tmpINTERRUPT_0__RTC_COT_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RTC_COT_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
