// ======================================================================
// ECE381_SP23_Lab06_Wirless_Light_Controller.v generated from TopDesign.cysch
// 03/21/2023 at 20:16
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3fc5a77f-b9bc-43d8-aa6d-a6f21612210b/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__NRF24_IRQ_net;
	wire [0:0] tmpFB_0__NRF24_IRQ_net;
	wire [0:0] tmpIO_0__NRF24_IRQ_net;
	wire [0:0] tmpINTERRUPT_0__NRF24_IRQ_net;
	electrical [0:0] tmpSIOVREF__NRF24_IRQ_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		NRF24_IRQ
		 (.oe(tmpOE__NRF24_IRQ_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NRF24_IRQ_net[0:0]}),
		  .io({tmpIO_0__NRF24_IRQ_net[0:0]}),
		  .siovref(tmpSIOVREF__NRF24_IRQ_net),
		  .interrupt({tmpINTERRUPT_0__NRF24_IRQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NRF24_IRQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NRF24_CE_net;
	wire [0:0] tmpFB_0__NRF24_CE_net;
	wire [0:0] tmpIO_0__NRF24_CE_net;
	wire [0:0] tmpINTERRUPT_0__NRF24_CE_net;
	electrical [0:0] tmpSIOVREF__NRF24_CE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		NRF24_CE
		 (.oe(tmpOE__NRF24_CE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NRF24_CE_net[0:0]}),
		  .io({tmpIO_0__NRF24_CE_net[0:0]}),
		  .siovref(tmpSIOVREF__NRF24_CE_net),
		  .interrupt({tmpINTERRUPT_0__NRF24_CE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NRF24_CE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : demux_1
        ...
        always @(Net_28 or Net_54)
        begin
            case (Net_54[1:0])
                2'b00:
                begin
                    tmp__demux_1_0_reg = Net_28;
                ...
                begin
                    ...
                    tmp__demux_1_1_reg = 1'b0;
                    tmp__demux_1_2_reg = 1'b0;
                    tmp__demux_1_3_reg = Net_28;
                end
            endcase
        end
        assign Net_39 = tmp__demux_1_0_reg;
        assign Net_40 = tmp__demux_1_1_reg;
        assign Net_41 = tmp__demux_1_2_reg;
        assign Net_42 = tmp__demux_1_3_reg;
    end
    // -- De Mux end --
	...
	cy_psoc3_pins_v1_10
		#(.id("bfbc37c0-1142-4ac7-8a41-f1a42a41a208"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dfba3539-5da6-4060-a748-3414c4593b99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("354b1014-12ce-430d-bd51-aefefaffa6e0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d111c638-8c7e-42a5-8a98-8ceae2ba390d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 PWM_SEL (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_54[1:0]));
    defparam PWM_SEL.Bit0Mode = 0;
    defparam PWM_SEL.Bit1Mode = 0;
    defparam PWM_SEL.Bit2Mode = 0;
    defparam PWM_SEL.Bit3Mode = 0;
    defparam PWM_SEL.Bit4Mode = 0;
    defparam PWM_SEL.Bit5Mode = 0;
    defparam PWM_SEL.Bit6Mode = 0;
    defparam PWM_SEL.Bit7Mode = 0;
    defparam PWM_SEL.BitValue = 0;
    defparam PWM_SEL.BusDisplay = 1;
    defparam PWM_SEL.ExtrReset = 0;
    defparam PWM_SEL.NumOutputs = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("925edbb4-a947-4427-adea-7194c6ba4a20"),
	...
	cy_psoc3_pins_v1_10
		#(.id("086ae7ec-6e57-467f-8416-b55c97d6f75f"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
