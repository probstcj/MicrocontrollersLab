...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0bd6e4ba-451c-4d44-ae82-0c9cab37ff90/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__R0_net;
	wire [0:0] tmpFB_0__R0_net;
	wire [0:0] tmpIO_0__R0_net;
	wire [0:0] tmpINTERRUPT_0__R0_net;
	...
	cy_psoc3_pins_v1_10
		...
		R0
		 (.oe(tmpOE__R0_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__R0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__R0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4b195eec-92e4-4424-a655-225d9d6afb4c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ffacfb52-f202-4fb4-9397-65da29789f1c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1d36f474-116a-4358-9912-dccb13402a35"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__C0_net;
	wire [0:0] tmpFB_0__C0_net;
	wire [0:0] tmpIO_0__C0_net;
	wire [0:0] tmpINTERRUPT_0__C0_net;
	...
	cy_psoc3_pins_v1_10
		...
		C0
		 (.oe(tmpOE__C0_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__C0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__C0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
